...
export default {
  ...
  props: {
      ...
      textoSubArticuloCD:{
        type: String,
        default:"Hable con nuestros expertos"
      },
      tituloSubArticuloD:{
        type: String,
        default:"LEGAL|PRIVACIDAD|PROTECCION DE DATOS|BLOG"
      },
      textoSubArticuloDA:{
        type: String,
        default:"© 2020 DATALEJO "
      },
  }
};
</script>
